...
public class RenderHighwayman extends RenderBiped
{
    ...
    {		
        ...
        double d = (entityplayer.posX + (entityplayer.prevPosX - entityplayer.posX) * (double)f) - (entityplayer.prevPosX + (entityplayer.posX - entityplayer.prevPosX) * (double)f);
        double d1 = (entityplayer.posY + (entityplayer.prevPosY - entityplayer.posY) * (double)f) - (entityplayer.prevPosY + (entityplayer.posY - entityplayer.prevPosY) * (double)f);
        double d2 = (entityplayer.posZ + (entityplayer.prevPosZ - entityplayer.posZ) * (double)f) - (entityplayer.prevPosZ + (entityplayer.posZ - entityplayer.prevPosZ) * (double)f);
