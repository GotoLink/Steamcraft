...
public class ClientProxy extends CommonProxy implements ISimpleBlockRenderingHandler {
	...
	public void onRenderTick() {
		if (minecraft.thePlayer != null && minecraft.theWorld != null) {
			...
			if (helmetSlot != null && minecraft.gameSettings.thirdPersonView == 0 && helmetSlot.itemID == Steamcraft.brassGoggles.itemID && minecraft.currentScreen == null) {//if the player is wearing a helmet, perform the following actions
	...
	public static void drawTexturedModalRect(int i, int j, int k, int l, int i1, int j1) {
		...
		tessellator.addVertexWithUV(i + 0, j + j1, 0.0F, (k + 0) * f, (l + j1) * f1);
		tessellator.addVertexWithUV(i + i1, j + j1, 0.0F, (k + i1) * f, (l + j1) * f1);
		tessellator.addVertexWithUV(i + i1, j + 0, 0.0F, (k + i1) * f, (l + 0) * f1);
		tessellator.addVertexWithUV(i + 0, j + 0, 0.0F, (k + 0) * f, (l + 0) * f1);
		tessellator.draw();
	}
