...
public class BlockTeslaCoil extends BlockSCTorch
{
	...
	int l2 = world.getBlockMetadata(i, j, k);
		...
		int t3 = (j + f2 * nn);
           ...
           if((world.getBlockId(t1, t3, t2) == mod_Steamcraft.teslaReceiver.blockID || world.getBlockId(t1, t3, t2) == mod_Steamcraft.teslaReceiverActive.blockID) && nn >= 1) {
            world.setBlockMetadataWithNotify(t1, t3, t2, 1);
    ...
    public void updateTick(World world, int i, int j, int k, Random random)
    {
        ...
        if(!torchActive)
        {
            if(flag)
            {
                world.setBlockAndMetadataWithNotify(i, j, k, mod_Steamcraft.torchTeslaActive.blockID, world.getBlockMetadata(i, j, k));
        ...
        {
            world.setBlockAndMetadataWithNotify(i, j, k, mod_Steamcraft.torchTeslaIdle.blockID, world.getBlockMetadata(i, j, k));
        }
		world.scheduleBlockUpdate(i, j, k, blockID, tickRate());
    }
